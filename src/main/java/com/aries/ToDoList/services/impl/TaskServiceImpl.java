...
import com.aries.ToDoList.mapper.TaskRowMapper;
import com.aries.ToDoList.services.api.TaskService;
...
public class TaskServiceImpl implements TaskService {
    ...
    public List<Task> getTaskByUserId(Integer userId) {
        final String sql = " select * from task.userId =" + userId;
        try {
            return jdbcTemplate.query(sql,taskRowMapper);
        }
        catch (EmptyResultDataAccessException ex){
    ...
    public Integer add(Task task) {
        ...
        KeyHolder keyHolder = new GeneratedKeyHolder(); // KeyHolder sluzi na zadrzanie id ktore ma metoda vratit
